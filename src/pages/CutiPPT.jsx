...
const CutiPPT = () => {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      ...
      try {
        ...
        if (response.data.jenisPegawai === 'PPT') {
          setIsPPT(true);
        } else {
          setNotification("Anda bukan pegawai jenis PPT dan tidak boleh mengakses halaman ini.");
        }
      } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (isRequiredFieldsFilled && isPPT) {
      try {
        const response = await axios.post("http://localhost:8000/api/cuti/ppt/", {
          nama_pegawai: nama,
          nip_baru: nip,
      ...
      setNotification("Anda bukan pegawai jenis PPT dan tidak dapat mengajukan cuti di halaman ini.");
    } else {
      setIsFormComplete(false);
      ...
      <div style={{ backgroundColor: "#1E1E2D", minHeight: "100vh" }}>
        ...
        <div className="d-flex">
          ...
          <div className="p-4 text-white w-100">
            <h2 className="mb-4">Formulir Pengajuan Cuti PPT</h2>
            {notification && (
  ...
  return (
    <div style={{ backgroundColor: "#1E1E2D", minHeight: "100vh" }}>
      ...
      <div className="d-flex">
        <Sidebar />
        <div className="p-4 text-white w-100">
          <h2 className="mb-4">Formulir Pengajuan Cuti PPT</h2>{notification && (
            <div
          ...
          <form onSubmit={handleSubmit} className="cuti-form p-4 rounded shadow">
            ...
            <div className="d-flex justify-content-end">
              <button type="submit" className="btn btn-success" disabled={!isPPT}>
                Ajukan Cuti
              </button>
            </div>
          </form>
